...
import android.example.com.coolweather.gson.Forecast;
import android.example.com.coolweather.gson.Weather;
import android.example.com.coolweather.util.HttpUtil;
import android.example.com.coolweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(weatherString!=null){
           ...
           //  String weatherId=getIntent().getStringExtra("weather_id");
            int weatherId=getIntent().getIntExtra("weather_id",0);
    ...
    public void requsetWeather(final  int weatherId){
